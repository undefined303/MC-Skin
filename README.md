...
**<span style="color:red">第一次使用脚本前，需要自行修改脚本代码，填入自己的MC皮肤。</span>**

**<span style="color:red">具体方法如下：</span>**

**<span style="color:red">找到脚本代码中的</span>**
```
var skin = "";
```
**<span style="color:red">在`""`内填入你的皮肤的base64编码。</span>**

**<span style="color:red">base64编码可使用[菜鸟工具（点击可进入）](https://www.jyshare.com/front-end/59/)，或者其他支持图片转base64的工具来获取。</span>**
