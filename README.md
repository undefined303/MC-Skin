...
在网站里添加一个MC小人，视角跟随你的触摸或者鼠标位置移动。小人可以响应你的点击，鼠标滚轮滑动，打字输入操作，播放相应的动画。此外，当五分钟在该网页无操作时，小人会潜行开扭或者犯困。
...
3. 修改皮肤：点击 **更换皮肤** ，将弹出皮肤选择弹窗，目前支持多种上传皮肤方式：
   - 点击上传皮肤按钮来从本地上传皮肤文件；
   - 输入你的正版id来获取皮肤；
   - 输入皮肤链接来获取皮肤；
   - 拖拽皮肤图片到上传按钮上方，当按钮变成“+”时，松手以上传皮肤；
   - 复制皮肤文件后，直接 Ctrl+V 粘贴皮肤。
...
7. 可以配置鼠标跟随模式，可选java版和基岩版模式，默认为基岩版模式。两种模式具体区别为：
   - 基岩版模式仅头部视角跟随鼠标，身体会根据当前所处位置倾斜向屏幕纵中轴线，使用模拟基岩版光照（平行光）照明。
   - java版模式全身跟随鼠标，使用模拟java版光照（半球光）照明。
